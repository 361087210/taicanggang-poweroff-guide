...
echo ============================================
echo Cordova Android APK Build Script V5.1
echo ============================================
echo.
...
echo Syncing V5.1 files to Cordova www...
echo.
...
if exist "%APK_PATH%" (
    ...
    copy /Y "%APK_PATH%" "%~dp0release\太仓港断电指导V5.1.apk" >nul
    echo APK saved as: release\太仓港断电指导V5.1.apk
) else (
    echo.
...
echo.
echo V5.1 Build process complete.
