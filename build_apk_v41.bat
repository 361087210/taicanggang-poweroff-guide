...
echo ============================================
echo Cordova Android APK Build Script V4.1
echo ============================================
echo.
...
echo Syncing V4.1 files to Cordova www...
echo.
...
if exist "%APK_PATH%" (
    ...
    copy /Y "%APK_PATH%" "%~dp0???????V4.1.apk" >nul
    echo APK saved as: ???????V4.1.apk
) else (
    echo.
...
echo.
echo V4.1 Build process complete.
