# V10.14.4 发版说明: 网页版数据同步修复版(双根遍历+注册审批全链路打通)
发布日期: 2026-09-06  
...
> **彻底修复网页版与安卓端数据不同步的历史问题——之前安卓端能看到82组车型、网页版只有73组的根因已查明并修复,镜像脚本升级为三入口遍历(云盘根+配置根+旧根),组长在哪根写数据网页版都能5分钟内追上;组员安卓端注册、组长审批后,可直接在网页版登录,密码与账号信息完全一致。**
