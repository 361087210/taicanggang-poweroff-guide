 ...
 * =========================================================== */
// V10.16.5 安全加固: 生产环境(Cordova)静默 console.log, 保留 console.warn/error
if(typeof window!=='undefined'&&window.cordova&&typeof console!=='undefined'){
...
// V10.15.15: 统一车型数据池——vehicles_data.js为唯一内置数据源(demo.html已先加载)
// 内置73条+用户新增车型均在此数组,IndexedDB持久化+飞书云端同步
...
const MEDIA_DIRECT_ASSETS={
  ...
  /* ==== V10.17.1: 补齐23个缺失视频的真实Release资产(本地素材按车型名称配对) ====
   * 云端vehicle_videos目录丢失后,23个引用无直链。此处用本地
   * E:\车辆断电指导应用开发\vehicle_videos 下的真实同名文件上传的资产补齐,
   * 资产名=内容SHA-256前10位(长安皮卡与瑞虎8_CSH内容逐字节相同,故后者加_2区分,
   * 保持车型-资产一一对应,避免张冠李戴)。 */
  '上汽大通_大通货车.mp4':'tcgv_3d0e993e4d.mp4',
  '东风小康_MPVC37.mp4':'tcgv_4b14a1d1ef.mp4',
  '东风风神_风神HUGEMHD500T_MAGEMHD500T.mp4':'tcgv_54a5a92db2.mp4',
  '东风风行_T5EVO.mp4':'tcgv_ba44523dad.mp4',
  '吉利极氪_极氪001_X_7X.mp4':'tcgv_4cda31cd18.mp4',
  '吉利银河_EX5_银河E5_.mp4':'tcgv_6e6b51930c.mp4',
  '吉利领克_领克02.mp4':'tcgv_88925e8630.mp4',
  '奇瑞东南SOUEAST_S07.mp4':'tcgv_78fe67067e.mp4',
  '奇瑞东南SOUEAST_S08DM.mp4':'tcgv_b3d7b8ed9a.mp4',
  '奇瑞捷途JETOUR_DASHENG.mp4':'tcgv_44e962a169.mp4',
  '奇瑞捷途JETOUR_T1_I_DM.mp4':'tcgv_1d7b63d0d5.mp4',
  '奇瑞捷途JETOUR_T2_I_DM.mp4':'tcgv_8a31a3eac5.mp4',
  '奇瑞捷途JETOUR_T2_XWD.mp4':'tcgv_abb8e25867.mp4',
  '奇瑞捷途JETOUR_X50.mp4':'tcgv_77f5a28d53.mp4',
  '奇瑞捷途JETOUR_X70.mp4':'tcgv_e84bf378ac.mp4',
  '奇瑞瑞虎_瑞虎7PRO.mp4':'tcgv_212333ea73.mp4',
  '奇瑞瑞虎_瑞虎8_CSH.mp4':'tcgv_ec0bb6fa76.mp4',
  '奇瑞艾瑞泽_艾瑞泽5PRO.mp4':'tcgv_8a190f229f.mp4',
  '比亚迪海鸥_高配_天窗_.mp4':'tcgv_899fce1c47.mp4',
