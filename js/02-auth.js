 ...
 * doLogin 的 P0 惰性迁移)。**必须用 P0(>=10.19.2) 版 App 登录**: v10.19.1 不含 P0
 * (它仍是旧 phoneH 方案, 派生不出 linkKey), 故 10.19.1 的 App 永远补不了 linkKey。
 * 存量账号若从未在 P0(>=10.19.2) 版 App 登录过, 云端镜像就没有 linkKey →
 * 网页端无从校验 → doLogin 统一报"账号或密码错误"。
 * 用户以为密码错, 实为"迁移未完成"。
 *
