/* ===========================================================
 * 模块: 09-web-sync.js  网页版数据同步桥接层 V1.0 (V10.14.3 配套)
 * ===========================================================
 ...
 *
 * 覆盖范围(仅纯浏览器环境生效,安卓Cordova APP零影响):
 ...
 * ============================================================ */
window.feishuCfgReady=function(){return true;}; /* 网页镜像通道永远就绪(无需飞书凭据) */
...
console.log('[网页同步] 09-web-sync.js 桥接层已启用(同源镜像通道,60秒自动同步)');
})();
