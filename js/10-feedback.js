...
// V10.15.4 反馈6: 问题板块选项细化(原8项扩大为15项,覆盖车型/搜索/照片/详情/步骤/钥匙/单车导出等细分场景)
const CATEGORIES = [
  '车辆查询-车型列表', '车辆查询-搜索筛选', '车辆查询-照片视频', '车辆查询-车辆详情',
  '断电操作-步骤展示', '断电操作-钥匙处理', '断电操作-单辆车导出',
  '数据同步-更新下载', '数据同步-版本升级', '账号登录注册',
  '组员管理模块', '缓存与导出', '系统设置-界面按钮', '系统设置-提交反馈', '其他问题'
];
